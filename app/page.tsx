...
import { OnchainPayWorkflow } from "@/app/components/onchain-pay-workflow";
...
type View = "overview" | "binance" | "binance-pay" | "onchain-pay" | "wallet" | "x402" | "activity" | "settings" | "reports";
type SettingsTab = "Rules & approvals" | "Connections" | "Diagnostics" | "General";
const labels: Record<View,string>={overview:"Overview",binance:"Binance", "binance-pay":"Binance Pay", "onchain-pay":"Onchain Pay",wallet:"Agentic Wallet",x402:"x402",activity:"Activity",reports:"Reports",settings:"Settings"};
  ...
  return <main className="app-shell">
    <aside className={`sidebar ${menuOpen ? "open" : ""}`}>
      ...
      <nav className="nav-list" aria-label="Main navigation">
        ...
        <NavParent label="Binance" icon="B" active={view === "binance" || view === "binance-pay" || view === "onchain-pay"} open={binanceOpen} onNavigate={() => navigate("binance")} onToggle={() => setBinanceOpen((value) => !value)}/>
        {binanceOpen && <div className="nav-submenu"><NavButton active={view === "binance-pay"} icon="" label="Binance Pay" onClick={() => navigate("binance-pay")}/><NavButton active={view === "onchain-pay"} icon="" label="Onchain Pay" onClick={() => navigate("onchain-pay")}/></div>}
    ...
    <section className="content-area">
      ...
      <div className="page-content">
        ...
        {view === "onchain-pay" && <OnchainPayView/>}
...
function OnchainPayView(){return <PageFrame eyebrow="Binance Onchain Pay" title="Send from Binance to any supported blockchain" description="Use BNB, BTC, ETH, stablecoins, and every other asset/network currently supported by Binance Onchain Pay. Review in AgentPay, then authorize securely in Binance."><OnchainPayWorkflow/></PageFrame>}

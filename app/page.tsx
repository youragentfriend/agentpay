...
function ActivityView({timeZone}:{timeZone:string}){return <PageFrame eyebrow="Activity" title="All activity" description="Filter transfers, Binance Pay payments, x402 purchases, successes, pending actions, and failures."><ActivityWorkflow timeZone={timeZone}/></PageFrame>}

...
function X402View(){return <PageFrame eyebrow="Agentic Wallet / x402" title="x402 Service Finder" description="Discover with AI, browse validated services, or inspect an exact trusted endpoint across BSC, Base, and Solana."><X402Workflow/></PageFrame>}

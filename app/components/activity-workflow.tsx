  ...
  return <div className="activity-workspace">
    <div className="activity-toolbar">
      ...
      <div className="activity-filter-row">
        ...
        <select aria-label="Activity status" value={status} onChange={event => change(setStatus, event.target.value)}><option value="">All statuses</option><option value="in-progress">Pending</option><option value="successful">Successful</option><option value="failed">Failed</option></select>
    ...
    {loading ? <div className="workflow-message">Loading activity…</div> : !data.events.length ? <div className="empty-state"><div className="empty-icon">◷</div><h2>No matching activity</h2><p>Change or clear the filters to see payments, transfers, and purchases.</p></div> : <div className="activity-table">

...
const RAILS: Array<{ id: PaymentRail; label: string; tabLabel: string; help: string }> = [
  { id: "binance-pay", label: "Binance Pay", tabLabel: "Binance Pay", help: "Applied only to Binance Pay transactions." },
  { id: "x402", label: "x402", tabLabel: "x402", help: "Applied only to approved x402 purchases with a reliable USD valuation." },
  { id: "agentic-wallet", label: "Agentic Wallet", tabLabel: "Wallet", help: "Applied only to direct Agentic Wallet transfers." },
];

import { BinancePayError, binancePayErrorResponse, decodeBinanceQr, prepareBinancePayment } from "@/lib/server/binance-pay";
...
export async function POST(request: Request) {
  try {
    ...
    return Response.json({ sourceType: decoded.source_type, order: await prepareBinancePayment(decoded.qr_data) });
